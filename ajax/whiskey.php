<?php
include "../base.php";
$data = $Whiskey->find($_POST['editid']);
...
<div class="form-group flex ">
    ...
    <select name="type" id="type">
        ...
        <option value="Blended" <?=($data['type']=='Blended')?'selected':''?>>Blended</option>
        <option value="Bourbon" <?=($data['type']=='Bourbon')?'selected':''?>>Bourbon</option>
    </select>  
    </div>
    <div style="margin-left: 5rem;">
        <label for="memo"  class="col-form-label">Memo</label>
        <input type="text" class="form-control" id="memo" value="<?=$data['memo']?>">
    </div>
</div>
<div class="form-group flex">
    <div>
    ...
    <div>
        ...
        <input type="text"  class="form-control" id="chinese" value="<?=$data['chinese']?>">
    </div>
</div>
<div class="form-group flex_nowrap">
    <div>
        <label for="inprice" class="col-form-label">進價</label>
        <input type="number"  class="form-control" id="inprice" value="<?=$data['memo']?>">
    </div>
    <div>
        <label for="inputtime" class="col-form-label">報價時間</label>
        <input type="date"  class="form-control" id="inputtime" value="<?=$data['inputtime']?>">
    </div>
    <div>
        <label for="supply" class="col-form-label">廠商</label>
        <input type="text"  class="form-control" id="supply" value="<?=$data['supply']?>">
    </div>
</div>
<div class="form-group flex">
    <div>
        <label for="bottle" class="col-form-label">整瓶</label>
        <input type="number"  class="form-control" id="bottle" value="<?=$data['bottle']?>">
    </div>
    <div>
        <label for="glass" class="col-form-label">單杯</label>
        <input type="number"  class="form-control" id="glass" value="<?=$data['glass']?>">
    </div>
</div>
<div class="form-group flex">
    <div>
