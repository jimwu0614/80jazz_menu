...
<div class="form-group flex ">
    ...
    <select name="type" id="type">
        <option value="" >---</option>
        <option value="Cognac" <?=($data['type']=='Cognac')?'selected':''?>>Cognac</option>
        <option value="Armagnac" <?=($data['type']=='Armagnac')?'selected':''?>>Armagnac</option>
    </select>  
    </div>
